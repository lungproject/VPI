...
class DropBlock1Dmw(keras.layers.Layer):
    ...
    def __init__(self,
        ...
        """
        super(DropBlock1Dmw, self).__init__(**kwargs)
    ...
    def get_config(self):
        ...
        base_config = super(DropBlock1Dmw, self).get_config()
...
class DropBlock2Dmw(keras.layers.Layer):
    """See: https://arxiv.org/pdf/1810.12890.pdf"""
    ...
    def __init__(self,
        ...
        :param kwargs: Arguments for parent class.
        """
        super(DropBlock2Dmw, self).__init__(**kwargs)
        self.block_size = block_size
        self.keep_prob = keep_prob
        self.sync_channels = sync_channels
        self.data_format = data_format
    ...
    def get_config(self):
        config = {'block_size': self.block_size,
                  ...
                  'sync_channels': self.sync_channels,
                  'data_format': self.data_format}
        base_config = super(DropBlock2Dmw, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
